...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn('[&_tr]:border-b bg-slate-50/80 text-slate-700 font-semibold border-b border-slate-200/80', className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'h-10 px-3.5 text-left align-middle font-semibold text-slate-700 text-[11px] uppercase tracking-wider [&:has([role=checkbox])]:pr-0',
      className
    )}
    {...props}
  />
